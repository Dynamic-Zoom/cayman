...
![Before and After Enhancement](assets\pictures\qualityperformance.gif)

*Note the enhanced clarity and detail in the 'Bicubic++' image.*

When comparing just the upscaling quality:

![Upscaling Quality Comparison](assets\pictures\upscalercomparison.png)
...
![Latency Comparison](assets\pictures\latencyperformance.gif)
